...
class PickCubeFromLocationAction(GripperPrimitives):
    ...
    def do_work(self):
        ...
        if self.step == PickCubeStep.START:
            ...
            self.send_feedback(0.08, 'levantando garra para girar')
            ...
            self.send_feedback(0.16, 'girando para area de cubo')
            ...
            self.send_feedback(0.25, 'movendo para altura da mesa')
            ...
            self.send_feedback(0.33, 'indo para a frente do cubo')
            #funcao de mover
            time.sleep(1)
            ...
            self.send_feedback(0.41, 'avancando em direcao ao cubo')
            #funcao de mover
            time.sleep(1)
            self._pending_reply = 'move'
            self._current_reply = 'move' 
            ...
            self.send_feedback(0.58, 'recuando')
            #funcao de mover
            time.sleep(1)
            self._pending_reply = 'move'
            self._current_reply = 'move' 
            ...
            self.send_feedback(0.66, 'subindo para altura de giro')
            ...
            self.send_feedback(0.75, 'girando para chassi')
            ...
            self.send_feedback(0.83, 'abaixando para altura dos slots')
            ...
            self.send_feedback(0.91, 'abrindo garra')
